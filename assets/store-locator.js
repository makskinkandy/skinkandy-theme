...
function createMapContent(place) {
  ...
  let content = `<h6>${place.name} <span><img src="https://cdn.shopify.com/s/files/1/0555/7508/5194/files/MapPin_1.png" width="15"> ${distanceInKm}km</span></h6> <p>${place.vicinity}</p>`;
